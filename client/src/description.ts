...
export const requirements = [
    ...
    },
    {
        ...
        title: "Физические",
        desc: "Сдача нормативов: бег 100 м, бег 3 км, подтягивание.",
    },
    {
        icon: SchoolOutlinedIcon,
        title: "Академические",
        desc: "Отсутствие задолженностей. Средний балл не ниже 4.0.",
    },
];
...
export const documents = [
    ...
    "Паспорт (копия)",
    "Приписное или военный билет",
    "Медицинская справка (086/у)",
    "2 Фотографии 3×4",
    "Характеристика",
    "Копия зачётной книжки",
];
